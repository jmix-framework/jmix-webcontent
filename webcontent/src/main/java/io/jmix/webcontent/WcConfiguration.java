...
@PropertySource(name = "io.jmix.webcontent", value = "classpath:/io/jmix/webcontent/module.properties")
public class WcConfiguration {

    @Bean("wc_WcViewControllers")
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("io.jmix.webcontent"));
    ...
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("io.jmix.webcontent"));
        return actions;
    }
}
